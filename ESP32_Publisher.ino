/*
 * Proyecto: Instalación y Configuración de Mosquitto MQTT
 * Institución: ESCOM - IPN
 * Integrantes del equipo: 
 *Martinez MarinSebastian 
 *Mondragon Romero Montserrat
 *Negrete Pérez Juan Carlos
 *Sanchez De Jesus Arlet Berenice
 * Descripción: Publisher MQTT que envía datos a un broker en Raspberry Pi.
 */
...
const char* ssid = "INFINITUMA660";
const char* password = "TDet44tYAc"; 
